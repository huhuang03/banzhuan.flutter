...
class HuobiDepthTick {
  ...
  factory HuobiDepthTick.fromJson(Map<String, dynamic> json) =>
      _$HuobiDepthTickFromJson(json);
...
class HuobiDepth {
  ...
  factory HuobiDepth.fromJson(Map<String, dynamic> json) =>
      _$HuobiDepthFromJson(json);
