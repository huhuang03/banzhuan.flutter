  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      child: Column(
        children: [
          TextFormField(
            decoration: const InputDecoration(hintText: "Proxy Host:"),
            controller: ctrlHost,
          ),
          TextFormField(
            decoration: const InputDecoration(hintText: "Proxy Port:"),
            controller: ctrlPort,
          ),
          RaisedButton(
            child: Text("Sure"),
            onPressed: () {
              ...
              print('set Proxy called with ${ctrlHost.text}, ${ctrlPort.text}');
